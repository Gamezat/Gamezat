            ...
            <div key="" className="bg-white dark:bg-gray-800 border-gray-200 w-80 dark:border-gray-800 p-4  border shadow-lg max-w-md mb-2">
                <div className="flex justify-between">
                    <div className="flex items-center">
                        <img className="h-11 w-11 rounded-full " src="https://www.shutterstock.com/shutterstock/photos/2207855875/display_1500/stock-photo-anime-background-contryside-anime-inmage-k-2207855875.jpg" />
                        <div className="ml-1.5 text-sm leading-tight">
                            <span className="text-black dark:text-white font-bold block ">Name</span>
                            <span className="text-gray-500 dark:text-gray-400 font-normal block">Email</span>
                        </div>
                    </div>
                ...
                <div className="text-black dark:text-white block text-xl leading-snug mt-3">
                    ...
                    >content</ReactReadMoreReadLess>
                </div>
                <img className="mt-2 rounded-2xl border border-gray-100 dark:border-gray-700 " src="https://www.shutterstock.com/shutterstock/photos/2207855875/display_1500/stock-photo-anime-background-contryside-anime-inmage-k-2207855875.jpg" />

                <div className="border-gray-200 dark:border-gray-600 border border-b-0 my-1"></div>

                <div className='flex gap-3 mt-4 justify-center'>
                    <div>
                    <button type="button" class="inline-block px-10 font-bold py-3 bg-green-500 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-green-600 hover:shadow-lg focus:bg-green-600 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-green-700 active:shadow-lg transition duration-150 ease-in-out">Accept</button>
                    </div>
                    <div>
