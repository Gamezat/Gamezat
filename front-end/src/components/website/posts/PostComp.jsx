                                ...
                                <div className='bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-800 p-1 w-full rounded-xl'>
                                    <div class="flex">
                                        ...
                                        <Textarea ref={commentInput} name='comment'
                                            ...
                                            className="bg-transparent scrollbar-hide ring-amber active:ring-amber focus:shadow-md focus:border-amber focus:ring-amber  shadow-lg text-gray-400 rounded font-medium text-lg w-full" rows="1" cols="50" placeholder="What's happening?" />
                                    </div>
                                    <div class="flex">
                                        <div class="w-10"></div>
                                        <div class="w-64 px-2">
