...
export default function Chat() {
  return (
    <>
    <div className='max-h-screen flex flex-col justify-end sticky top-0 w-96'>
      <div className=''>
        Community Chat Wall
      </div>
    	<div class="flex h-[42rem] flex-col flex-grow w-fit  max-w-md bg-white shadow-xl rounded-lg overflow-hidden">
		...
		<div class="bg-gray-300 p-4 sticky bottom-0">
