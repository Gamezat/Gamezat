    ...
    return (
        <>
            <form className='' onSubmit={handleSubmit}>
                <div className="mb-5 shadow-xl shadow-lightGray/20 bg-white dark:bg-gray-800 border-amber dark:border-amber p-4 rounded-xl border border-t-4 border-b-2 max-w-lg">
                    <div className='bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-800 p-4 rounded-xl'>
                        <div class="flex">
                            ...
                            <Textarea ref={inputPost}
                                onChange={(e) => setContent(e.target.value)} className="bg-transparent scrollbar-hide  shadow-lg text-gray-400  focus:ring-amber focus:border-amber   rounded font-medium text-lg w-full" rows="2" cols="50" placeholder="What's happening?" />

                        </div>
                    </div>
                    <div class="flex justify-around ">
                        <label htmlFor='image-upload' class="px-2 ring-1 h-9 hover:cursor-cell group flex items-center justify-center border-none text-lightGray dark:text-amber text-base leading-6 font-medium rounded-full hover:text-amber hover:shadow-lg hover:shadow-red transition duration-300 hover:duration-300 ease-in-out">
                            <span>
                                ...
                                <input name='image' id='image-upload' hidden type="file"
                                    onChange={(e) => {
