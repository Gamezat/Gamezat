...
export default function RegistrationPortal() {
    ...
    const { showPortal, setShowPortal, googleLoginFun, FacebookLoginFun, loginFun, registerFun } = useContext(AuthContext)
    useEffect(() => {
        AOS.init({ once: true });
    }, [])
                        ...
                        <Card data-aos="fade-up  "
                            ...
                            <CardFooter className="pt-0">
                                ...
                                <div className=' mt-3 gap-16 flex items-center justify-center  '>
                                    ...
                                    ><FaFacebook className='w-5 h-5' /></FacebookLogin>
                                </div>
                                <Typography variant="small" className="mt-6 flex justify-center">
                                    ...
                                    >
                                        <span className='cursor-pointer' onClick={() => setForm(!form)} > {form ? "Sign up" : "Login"}  </span>
                                    </Typography>
                                </Typography>
                                <hr class="my-2 h-px bg-gray-200 border-0 dark:bg-gray-700"></hr>
                                <Button onClick={() => { setShowPortal(!showPortal); setForm(true) }} variant="gradient" color='red' fullWidth>
                                    Cancel
                                </Button>
                            </CardFooter>
                        </Card>
