...
export default function Community() {
    ...
    return (
        <>
            ...
            {blogs?.map((blog) => {
                return (
                    <div key={blog?.id} className="bg-white dark:bg-gray-800 border-gray-200 w-80 dark:border-gray-800 p-4 rounded-xl border max-w-md mb-2">
                        ...
                        <div className="text-gray-500 dark:text-gray-400 flex mt-3">
                            <div className="flex items-center mr-6">
                                ...
                                <span className="ml-2">{blog?.like ? blog?.like.likes : '0'}</span>
                            </div>
