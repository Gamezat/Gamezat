...
export default function Community() {
    ...
    return (
        <>
            <div className='flex dark:bg-lightGray justify-around flex-wrap  p-10 rounded-3xl border-t-4 shadow-lg w-[95%] mx-auto border-grass  dark:bg-slate-800'>
                                    ...
                                    <div className="flex justify-between">
                                        <div className="flex items-center">
                                            ...
                                            <div className="ml-1.5 text-sm leading-tight">
                                                <Link to={`/profile/${blog?.user.id}`} > <span className="text-black dark:text-white font-bold block ">{blog?.user.name}</span></Link>
