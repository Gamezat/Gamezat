...
export function AuthProvider({ children }) {
    ...
    return (
        <>
            <AuthContext.Provider value={{ showPortal, setShowPortal, token, googleLoginFun, setUser, user, FacebookLoginFun, emailInput, passwordInput, loginFun, nameInputR, emailInputR, passwordInputR, rPasswordInputR, registerFun, logout }}>
                {children}
