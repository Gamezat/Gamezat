    ...
    return (
        <>
            ...
            <div className="my-10  dark:bg-blue-gray-900 ">
                <h1 className="p-6 text-3xl ml-4 text-center flex  "> <IoGiftSharp className="mr-2 text-indigo" />Free Games</h1>
                <SwiperGiftGame />
            </div>
            ...
            <div className="mt-6 ">
                <h1 className="p-6 text-3xl ml-5 text-center flex "><GiStaryu className="mr-2 text-lemon" />Top Rated Games</h1>
            ...
            <div className="mt-6 ">
                <div className="flex justify-between">
                    ...
                    <h1 className="p-6 ml-5 text-3xl text-center flex "><IoAccessibilitySharp className="mr-2 text-grass" />Community</h1>
            ...
            <div className="mt-6 text-center">
                ...
                <h1 className="p-6 text-3xl ml-5 text-center flex "><GiAbstract050 className="mr-2  text-purple-800 " /> Play A Random Game </h1>
                < RandomGame />
            </div>
